...
function han84B() {
    allMain = `<br><br><br><br><section>You use your perfect stick to interact with the perfect shape, a perfect combo for a perfectly cool magician. The pops away from reality, the angelically iridescent light disappears, and your brain forms ideas you've never had before. You think about sticks too.<br><br><button onclick="lvlUp()">[Increase a skill.]</button></section>`
    saveState = `han86`;
    end();
}
function han85() {
