...
let allCityInfo = [{ type: `normal`, items: [0, 6, 5], cityDungeon: `matx`, localDialogue: `"Well, whatt'ya want then?!"`, cityDesc: `Murky water layers itself underneath the plywood boards that the buildings rest upon. You question how structurally sound this place is.`, dungeonComplete: false }, { type: `normal`, items: [5, 8, 9], cityDungeon: `none`, localDialogue: `You came a long way, didn't you`, cityDesc: `This place, it's unreal. The golden glimmer of the vast fields in the distance remind you of sunshine mixed with your favorite childhood memories. The surrounding buildings are detailed by historical glyphs.` }, { type: `normal`, items: [6, 3, 8], cityDungeon: `none`, localDialogue: `"Welcome to our humble town."`, cityDesc: `The city is upkept by its minimalistic features, ran by simple people.` }, { type: `normal`, items: [1, 5, 9], cityDungeon: `paulx`, localDialogue: `"Well, hello there"`, cityDesc: `The main square is bustling with life, trade, and business. A pleasant aroma flows through the streets.`, dungeonComplete: false }, { type: `normal`, items: [10, 7, 4], cityDungeon: `hanx`, localDialogue: `"I sell fairy dust on the weekends by the pouch."`, cityDesc: `The urban style of the city is unmatched. Or, would be if the King gave further funding here.`, dungeonComplete: true }, { type: `normal`, items: [5, 2, 8], cityDungeon: `none`, localDialogue: `"Lol XD lmao" X3`, cityDesc: `You are in a silly place.` }];
let pItems = [];
let allPSpellType = [
    `fire`,
    `water`,
...
function displayPlayerPos() {
    pMap = map.split(``);
    pMap[playerX + playerY * 202] = `<strong class="player-pos">P</strong>`;
    pMap = pMap.join(``);
    printMap();
}
